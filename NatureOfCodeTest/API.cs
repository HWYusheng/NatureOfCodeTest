...
namespace NatureOfCodeTest
{
    ...
    public class API
    {
        ...
        private const string StarURL = "https://exoplanetarchive.ipac.caltech.edu/TAP/sync?query=select+top+100+hostname,st_mass,st_lum+from+stellarhosts+where+st_mass+is+not+null+and+st_lum+is+not+null&format=json";
